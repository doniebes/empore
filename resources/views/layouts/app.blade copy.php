...
<!-- REUSE FROM LIBRARY OLD -->
  ...
  <!-- <script src="<?//= base_url('/media/js/fullcalendar/fullcalendar.js');?>"></script> -->

  <!-- Datatables css -->
  <!-- <link href="<?//= media_url() ?>gomahad/assets/vendor/datatables.net-bs5/css/dataTables.bootstrap5.min.css" rel="stylesheet" type="text/css" />
  <link href="<?//= media_url() ?>gomahad/assets/vendor/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css" rel="stylesheet" type="text/css" />
  <link href="<?//= media_url() ?>gomahad/assets/vendor/datatables.net-fixedcolumns-bs5/css/fixedColumns.bootstrap5.min.css" rel="stylesheet" type="text/css" />
  <link href="<?//= media_url() ?>gomahad/assets/vendor/datatables.net-fixedheader-bs5/css/fixedHeader.bootstrap5.min.css" rel="stylesheet" type="text/css" />
  <link href="<?//= media_url() ?>gomahad/assets/vendor/datatables.net-buttons-bs5/css/buttons.bootstrap5.min.css" rel="stylesheet" type="text/css" />
  <link href="<?//= media_url() ?>gomahad/assets/vendor/datatables.net-select-bs5/css/select.bootstrap5.min.css" rel="stylesheet" type="text/css" /> -->
...
<body>
    ...
    <!-- <header>
        <nav>
            <ul>
                <li><a href="{{ route('books.index') }}"><span class="merah"> Daftar Buku</span></a></li>
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="footer">
      <div class="row justify-content-between align-items-center">
        <div class="col">
          <p class="fs-6 mb-0"><?//= $this->config->item('created') ?></span></p>
        </div>
        <!-- End Col -->
